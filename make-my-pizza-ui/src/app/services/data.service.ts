...
import { IDataService } from '../iservices/idata.service';
import { ClientResponse } from '../models/common.model';
...
export class DataService implements IDataService {
  ...
  public get<T>(relativePath: string, showDataLoading: boolean = true): Observable<T | null> {
    this.dataLoaderService.display(showDataLoading);
    return this.httpClient.get<ClientResponse>(this.actionUrl + relativePath)
      .pipe(
        map((response) => {
          this.dataLoaderService.display(false);
          if (response.success) {
